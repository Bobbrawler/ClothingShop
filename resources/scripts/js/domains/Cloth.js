...
class Cloth {
  constructor(
    name = constants_6.allClothesNames.UNDEFINED,
    brand = constants_1.brands.UNDEFINED,
    size = constants_2.sizes.UNDEFINED,
    color = constants_3.colors.UNDEFINED,
    material = constants_4.materials.UNDEFINED,
    gender = constants_5.genders.UNDEFINED
  ) {
    this.name = name;
    this.brand = brand;
    this.size = size;
