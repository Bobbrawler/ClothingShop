...
class Jacket extends Cloth_1.Cloth {
  constructor(
    name = constants_7.allClothesNames.UNDEFINED,
    brand = constants_2.brands.UNDEFINED,
    size = constants_3.sizes.UNDEFINED,
    color = constants_4.colors.UNDEFINED,
    material = constants_5.materials.UNDEFINED,
    gender = constants_6.genders.UNDEFINED,
    embellishment = constants_1.embellishments.UNDEFINED
  ) {
